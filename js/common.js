...
function openPlunker(css) {
	var postData = {};
	
	var html = "";
	$('#sampleHtml li').each(function(index, element) { 
		html += $(element).text() + '\n';
	});
	
	postData['description'] = 'AngularJS NgAnimate.org Sample';
	postData['files[style.css]'] = css;
	postData['files[index.html]'] = html;
	postData['private'] = true;
	postData['tags[]'] = 'nganimate';
