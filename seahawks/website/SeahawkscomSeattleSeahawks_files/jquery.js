...
/*
 * Modified by Lucas Cambra @ NFL.com
 */
...
(function($){
	$.fn.slides = function( option ) {
		...
		return this.each(function(){
            ...
            /* $(elem).bind('animateNext', function() {
                animate('next', effect);
            });
            $(elem).bind('animatePrev', function() {
                animate('prev', effect);
            });
            $(elem).bind('animateNextFade', function() {
                animate('next', 'fade');
            });
            $(elem).bind('animatePrevFade', function() {
                animate('prev', 'fade');
            }); */
            $(elem).bind('animateNextSlide', function() {
                animate('next', 'slide');
            });
            $(elem).bind('animatePrevSlide', function() {
                animate('prev', 'slide');
            });
