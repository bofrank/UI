...
?>
		...
		function login()
		{
			...
			/*
			var r=confirm("Do you want to show the dial pad for calling "+tapIdCallee+"?");
      if (r == true) {
				showdialpad(tapIdCallee);
			}*/
		}
		...
		function showdialpad(tapIdCallee)
		{
...
<div id="contentTopics" class="topics">
    ...
    <ul id="content" ng-model="numbers">
        <li ng-repeat="whatever in numbers|filter:filterTapId" class="imgs row">
            ...
            <div class="number" onclick="showdialpad($(this).text());">{{whatever.tapid}}</div>
            <div style="clear:both;"></div>
    ...
    <section id="callchat" style="background:none;margin:10px auto;text-align:center;">
        ...
        <div style="width:100%;">
            <div id="buttonOpenPad" class="container" onClick="showdialpad();" style="text-align:center;width:50%;height:50px;float:left;margin-top:20px;">
